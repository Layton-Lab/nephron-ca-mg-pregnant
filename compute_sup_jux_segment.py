...
def compute_segment(sup_or_jux,sex,species,sup_or_multi,diabete,inhib,unx,preg,HT,HCa, hypoCa, hypoMg, file_to_save):
    ...
    pt, fluxvals_pt =compute(NPT,filename,'Broyden',sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT=HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f'pt_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(pt, file)
    #with open(f'fluxvals_pt_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_pt, file)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/S3params_F_'+species[0:3]+'.dat'
    s3, fluxvals_s3=compute(NS3,filename,'Newton',  sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx,preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f's3_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(s3, file)
    #with open(f'fluxvals_s3_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_s3, file)
    ...
    sdl, fluxvals_sdl =compute(NSDL,filename,method ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f'sdl_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(sdl, file)
    #with open(f'fluxvals_sdl_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_sdl, file)
    ...
    if sup_or_jux != 'sup':
        ...
        if sex == 'Male':
            ...
            filename ='./datafiles/LDLparams_F_'+species[0:3]+'.dat'
        ldl, fluxvals_ldl =compute(NLDL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #========================================================
        ...
        if sex == 'Male':
            ...
            filename ='./datafiles/LALparams_F_rat.dat'
        lal, fluxvals_lal =compute(NLAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/mTALparams_F_'+species[0:3]+'.dat'
    mtal, fluxvals_mtal =compute(NmTAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f'mtal_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(mtal, file)
    #with open(f'fluxvals_mtal_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_mtal, file)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/cTALparams_F_'+species[0:3]+'.dat'
    ctal, fluxvals_ctal=compute(NcTAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f'ctal_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(ctal, file)
    #with open(f'fluxvals_ctal_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_ctal, file)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/DCTparams_F_'+species[0:3]+'.dat'
    dct, fluxvals_dct =compute(NDCT,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f'dct_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(dct, file)
    #with open(f'fluxvals_dct_{sex}__final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_dct, file)
    ...
    if sex == 'Male':
        ...
        filename ='./datafiles/CNTparams_F_'+species[0:3]+'.dat'
    cnt, fluxvals_cnt =compute(NCNT,filename,'Newton' , sup_or_jux,diabete,species,sup_or_multi,inhib,unx = unx, preg = preg, HT = HT, HCa=HCa, hypoCa = hypoCa, hypoMg = hypoMg)
    ...
    #with open(f'cnt_{sex}_final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(cnt, file)
    #with open(f'fluxvals_cnt_{sex}__final_check_{inhib}.pickle', 'wb') as file:
     #   pickle.dump(fluxvals_cnt, file)

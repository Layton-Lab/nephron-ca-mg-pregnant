    ...
    while (line):
        ...
        if line[0][0]!='#':
            ...
            # Membrane solute permeabilities:
                ...
                if cell.segment == 'PT' or cell.segment == 'S3':
                    '''
                    if sid == 15 and ind1 == 0 and ind2 == 4:
                        ...
                        if cell.type == 'sup':
                            if cell.preg == 'late':
                                ...
                                cell.h[sid,ind1,ind2] = cell.h[sid,ind1,ind2]*preg_rat
                                cell.h[sid,ind2,ind1] = cell.h[sid,ind1,ind2]
                    ...
                    if sid == 15 and ind1 == 0 and ind2 == 1:
                        if cell.type == 'sup':
                            if cell.preg == 'late':
                                preg_rat = 1.2
            ...
            # Specific transporters:
                ...
                elif newTransp.type == 'TRPV5':
                    if cell.segment == 'DCT' or cell.segment == 'CNT':
                        ...
                        if cell.type == 'sup':
                            if cell.preg == 'mid':
                                preg_rat = 1.9 * hypo_effect
                            elif cell.preg == 'late':
                                preg_rat = 1.3 * hypo_effect
                        else:
                            if cell.preg == 'mid':
                                preg_rat = 1.1 * hypo_effect
                            elif cell.preg == 'late':
                                preg_rat = 1.1 * hypo_effect

                elif newTransp.type == 'NCX1':
                    if cell.segment == 'DCT' or cell.segment == 'CNT':
                        ...
                        if cell.preg == 'mid':
                            preg_rat = 1.4 * hypo_effect
                        elif cell.preg == 'late':
                            preg_rat = 1.3 * hypo_effect
                
                
                elif newTransp.type == 'TRPM6':
                    if cell.segment == 'DCT' or cell.segment == 'CNT':
                        ...
                        if cell.type == 'sup':
                            if cell.preg == 'mid':
                                preg_rat = 1.7 * hypo_effect
                            elif cell.preg == 'late':
                                preg_rat = 1.3 * hypo_effect
                        else:
                            if cell.preg == 'mid':
                                preg_rat = 2.2 * hypo_effect
                            elif cell.preg == 'late':
                                preg_rat = 1.3 * hypo_effect           

                elif newTransp.type == 'NaMgX':
                    if cell.segment == 'DCT' or cell.segment == 'CNT':
            ...
            # Solute concentrations:
                ...
                if cell.hypoCa== 'Y':
                    if cell.segment == 'PT':
                        cell.conc[15,0] = 1.125

                # Hypomagnesemia
                if cell.hypoMg == 'Y':
                    if cell.segment == 'PT':
                        cell.conc[16,0] = 0.432  
            ...
            # Actual volume flows:
                ...
                if cell.segment == 'PT' and cell.type == 'sup':
                    ...
                    if compart_id[tmp[1]] == 0:
                        if cell.preg == 'mid':
                            cell.vol[0] = 0.007224 #0.0056*1.29
                        elif cell.preg == 'late':
                            cell.vol[0] = 0.006664 #0.0056*1.19
                        cell.vol_init[0] = cell.vol[0]
                    else:
                        cell.vol[compart_id[tmp[1]]] = float(num[0])
                        cell.vol_init[compart_id[tmp[1]]] = float(num[0])
